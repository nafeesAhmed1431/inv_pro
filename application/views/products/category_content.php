                        ...
                        <?php if (!empty($data)) : ?>
                            <?php foreach ($data as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-id="<?= $row->id ?>" title="Edit Category" href="javascript:void(0)" class=" edit_category badge bg-label-info"><span class="bx bxs-pencil"></span></a>
                                        <a data-id="<?= $row->id ?>" title="Delete Category" href="javascript:void(0)" class=" delete_category badge bg-label-danger"><span class="bx bxs-trash-alt"></span></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
