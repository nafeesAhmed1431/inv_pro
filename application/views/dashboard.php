            ...
            <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h3 class="card-title text-primary"><?= date('h:i A'); ?></h3>
                                <p class="mb-4">
                                ...
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                            <a class="dropdown-item" href="<?= base_url('branches') ?>">View</a>
                                        </div>
                                    </div>
                                </div>
                                <span class="fw-medium d-block mb-1">Total Branches</span>
                                <h3 class="card-title mb-2"><?= $total_branches ?? 0 ?></h3>
                                ...
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                            <a class="dropdown-item" href="<?= base_url('employees') ?>">View</a>
                                        </div>
                                    </div>
                                </div>
                                <span>Total Employees</span>
                                <h3 class="card-title text-nowrap mb-1"><?= $total_employees ?? 0 ?></h3>
                                ...
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                            <a class="dropdown-item" href="<?= base_url('drivers') ?>">View</a>
                                        </div>
                                    </div>
                                </div>
                                <span class="d-block mb-1">Total Drivers</span>
                                <h3 class="card-title text-nowrap mb-2"><?= $total_drivers ?? 0 ?></h3>
                                ...
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                            <a class="dropdown-item" href="<?= base_url('users') ?>">View</a>
                                        </div>
                                    </div>
                                </div>
