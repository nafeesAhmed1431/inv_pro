                        ...
                        <?php if (!empty($data)) : ?>
                            <?php foreach ($data as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-id="<?= $row->id ?>" title="View Details" href="javascript:void(0)" class="view_supplier badge bg-label-primary"><span class="bx bx-detail"></span></a>
                                        <a data-id="<?= $row->id ?>" title="Edit" href="javascript:void(0)" class="edit_supplier badge bg-label-info"><span class="bx bxs-pencil"></span></a>
                                        <a data-id="<?= $row->id ?>" title="Delete" href="javascript:void(0)" class="delete_supplier badge bg-label-danger"><span class="bx bxs-trash-alt"></span></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
